...
function Gachibowli() {
    ...
    return (
        <div className='text-black pt-36 lg:py-12 text-xs lg:text-base leading-7 lg:leading-9 '>
            <h1 className='font-bold text-xl lg:text-4xl xl:mx-72 lg:mx-80 mx-6'>Drive yourself around Hyderabad with self-drive cars from Gachibowli </h1>
            ...
            <div className='xl:mx-72 lg:mx-80 mx-6'>
                ...
                <p className='font-bold lg:text-xl py-1 lg:pt-8 pt-4'>Why Choose Self-Drive in Gachibowli?</p>
                <ul>
