...
const RandomPosts = ({ data }) => {
    ...
    return (
        <div className='pt-1 border-t-2 border-gray-300'>
            <p className='text-left text-2xl font-semibold pt-4 leading-6 capitalize'>explore more stories
            </p>

            <div className={` grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-4 xl:gap-10 lg:mt-2 pt-10`}>
