  ...
  return (
    <div className="lg:pt-6 border-t-2 border-gray-300 pt-8 px-3">
                ...
                <h5 className="mb-2">
                  <Link
                    href={`/blog/posts/${post.slug
                      .toLowerCase()
                      .replace(/ /g, "-")}`}
                    className="block hover:text-orange-500  text-lg xl:text-2xl text-left pt-4 tracking-tight helvetica-font"
                  >
                    <p className="h-20 overflow-hidden font-extrabold">
                    ...
                    <p className="text-left text-[#6B6B6B] text-base pt-4 tracking-wide font-light leading-5 lg:hidden block">
                      {ParseP(post?.content) &&
                ...
                <li>
                  <div className="flex gap-4 items-center lg:gap-8 py-2">
                    <p className="flex items-center gap-1">
                      ...
                      {/* Display likes count from state */}
                    </p>
                    <p className="flex items-center gap-1">
                      <span className="hover:cursor-pointer">
      ...
      <div
        className={`${
          showall ? "" : "hidden"
        } grid grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-4 xl:gap-10 lg:mt-2 px-3 lg:px-0 pt-10`}
      >
        {data?.length > 0 ? (
          data.slice(2, 8).map((post, i) => (
            <div key={`key-${i}`} className="lg:px-0  w-full">
              ...
              <ul className="mb-4 mt-auto flex flex-wrap justify-items-center space-x-4 text-[10px] pt-4">
