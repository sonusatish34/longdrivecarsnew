...
import { fireDb } from "../../../api/firebase"; // Adjust this import according to your setup
          ...
          <tbody>
            {postsToDisplay.map((post) => (
              <tr key={post.id} className="text-center border-b">
                ...
                <td className="py-2 truncate w-20 text-wrap">{post.title}</td>
                {/* <td className="py-2 truncate" dangerouslySetInnerHTML={{ __html: post.content }}></td> */}
                <td className="py-2">{post?.description && post?.description.slice(0, 40)}...</td>
                ...
                <td className="py-2 flex gap-4 px-2 justify-around">
                  ...
                  <FontAwesomeIcon
                    ...
                    icon={faTrash}
                  />
                  <Link href={`/Admin/Posts/UpdatePost/${post.id}`}>
      ...
      {loading ? (
        ...
        <>
          <div className="flex justify-between mb-4">
            <Link
              href="/blogadmin/Admin/Posts/NewPost"
