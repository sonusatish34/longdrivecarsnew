    ...
    return (
        <div className='pt-20 lg:py-8 flex flex-col lg:flex-row gap-12'>
            ...
            <div className=' bg-white'>
                <p className=' text-center pt-5 text-lg font-bold text-black'>Explore Cars Near You in 20 Kms</p>
                                    ...
                                    >
                                        {getOrderedImages(item?.attributes).map((imageSrc, index) => (
                                            <div key={index} onClick={() => {
                                                ...
                                                <Image className='h-[530px]' width={1000} height={1000} src={replaceText(imageSrc)} alt={`Car image ${index + 1}`} />
                                            </div>
                                        ))}
                                    </Slider>
                                    {/* </Link> */}
