        ...
        <div className='text-black bg-white pt-7 px-2 py-2'>
            <div className='bg-white text-black lg:text-lg text-sm lg:leading-9 leading-7 lg:pt-2 pt-28'>
                ...
                <div className='lg:px-16 px-2 pt-4'>
                    ...
                    <p>Phone:<Link className='underline' href={'tel:9000478478'}>+91 9000-478-478</Link></p>
                    ...
                    <p>You can also visit our office at:  Long Drive Cars, Pillar No 129, Main Road, beside Medipally, Medipally, Hyderabad, Telangana 500098 , <Link className='underline' href={'tel:9000478478'}>+91 9000-478-478</Link>.</p>
                    ...
                    <p className='flex gap-4'>
                        ...
                        <Link className='underline' href={'https://www.instagram.com/longdrivecars_hyderabad/'}>Instagram</Link>
                    </p>
