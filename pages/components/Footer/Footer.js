                        ...
                        <div>
                            <div>
                                ...
                                <div className='flex flex-col gap-1 '>
                                    <Link href={`/${forblog?'hyderabad/privacy-policy.html':`${locname}/privacy-policy.html`} `} target='_blank'>
                                        <p className='hover:text-blue-500 cursor-pointer'>Terms & Conditions</p>
                                    </Link>
                                    <Link href={`/${forblog?'hyderabad/privacy-policy.html#cancel_refund_policy':`${locname}/privacy-policy.html#cancel_refund_policy`} `} target='_blank'>
