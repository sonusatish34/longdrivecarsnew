...
function shamshabad() {
    ...
    return (
        <div className='text-black pt-48 lg:py-12 text-xs lg:text-base leading-7 lg:leading-9 '>
            <h1 className='font-bold text-base lg:text-3xl xl:mx-72 lg:mx-80 mx-6'>Explore the variety of self-drive car services in Shamshabad</h1>
            <Image
                src={punch}
                height={2000}
                width={2000}
            ...
            <p className='pb-2'>A wide range of vehicles are available for self-drive car services in Shamshabad, regardless of whether you're traveling alone, with family, or with friends. You may choose the best vehicle for your trip, from little hatchbacks that are great for city driving to roomy SUVs that are great for road excursions</p>
            <p className='font-bold'>Popular Destinations to Explore with Self-Drive Cars in Shamshabad</p>
