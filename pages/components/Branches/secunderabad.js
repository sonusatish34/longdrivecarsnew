    ...
    return (
        <div className='text-black pt-48 lg:py-12 text-xs lg:text-base leading-7 lg:leading-9 '>
            ...
            <div className='xl:mx-72 lg:mx-80 mx-6'>
                ...
                <p className='pb-2'>Though many companies in the area offer self-drive cars, Self Drive Cars Secunderabad stands out with a wide selection of brand-new vehicles. You can enjoy unlimited kilometers and zero deposit with<strong> Self Drive Cars Secunderabad</strong>. Additionally, they offer special deals on weekdays and weekends.</p>
                <p className='pb-2'>Renting a car from<strong>Self Drive Cars Secunderabad</strong>  allows you to enjoy privacy and comfort. Whether you choose a luxurious vehicle like an Innova, XUV 500, or Fortuner, you can travel around Hyderabad in style.</p>
