          ...
          <div className='lg:w-fit text-black lg:mt-2  xl:pl-56'>
            <div className={`${isOpen ? "hidden" : 'block'} hidden lg:block`}>
              <ul className='font-semibold xl:text-lg lg:text-base flex gap-8 xl:gap-12'>
                ...
                <li><Link target='_blank' className='hover:text-blue-400 hover:underline' href={`${locname?.length ? `/${locname}/contact.html` : '/attach&earn'}`}>Attach Car & Earn</Link></li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <Link href={'/'}>
          <div className='flex gap-3 cursor-pointer items-center pl-4 pb-2'>
            {/* <Image
              ...
              fetchpriority="high"
            /> */}
            <div className='w- text-black 2xl:w-full lg:w-96 lg:mt-2'>
