...
function dilshuknagar({ canonicalUrl }) {
  return (
    <div className='bg-white'>
      <Head>
        <title>LB Nagar Kothapet Self Drive Car Rentals</title>
        <meta name="description" content="Book car rental in LB Nagar Kothapet today. Safe, clean self drive cars with doorstep delivery and low prices." />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <meta property="og:title" content="LB Nagar Kothapet Self Drive Car Rentals" />
        <meta property="og:description" content="Book car rental in LB Nagar Kothapet today. Safe, clean self drive cars with doorstep delivery and low prices." />
