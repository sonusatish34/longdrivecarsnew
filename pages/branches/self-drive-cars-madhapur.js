...
function madhapur({canonicalUrl}) {
  return (
    <div className='bg-white'>
      
      <Head>
        <title>Madhapur Self Drive Cars for Rent Today</title>
        <meta name="description" content="Get car rental in Madhapur with flexible return and pickup. Safe and budget-friendly self drive car options."/>
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <meta property="og:title" content="Madhapur Self Drive Cars for Rent Today" />
        <meta property="og:description" content="Get car rental in Madhapur with flexible return and pickup. Safe and budget-friendly self drive car options."/> 
      ...
      <div className='text-black lg:px-16 px-4 leading-9 lg:leading-10 pt-40 lg:pt-16'>
        ...
        <p>While you are here, self drive to another gem nearby: Ramappa Lake. Carved under the patronage of Ganapathi Deva, the Kakatiyan ruler in 13 century - Ramappa Lake is said to be spread across an area of 82 Sq km. It is surrounded with exquisite hillocks standing on top of which you can gain impressive views of landscape around. However, the best time to view is ideally during the sunrise or sunset time.</p>
        <p>If lakes fascinate you, then there's another surprise in the form of Pakhal lake. Just about a distance of 50 kms on the eastern side of Warangal city, this lake beckons you with its serene setting, chirping of migratory birds, and sounds of wild animals. Self drive is again the best way to reach, because of the underdeveloped facility for the last mile connectivity to the Pakhal Lake. Of course, in the well maintained Long Drive Cars, the journey to the interiors of Warangal on the way to Pakhal Lake would be mesmerizing to say the least.</p>
...
export default madhapur;

export async function getServerSideProps({ req }) {
  
  const host = req.headers.host;
  const canonicalUrl = host.includes('.in')
      ? 'https://www.longdrivecars.in/branches/self-drive-cars-madhapur'
      : 'https://www.longdrivecars.com/branches/self-drive-cars-madhapur';
