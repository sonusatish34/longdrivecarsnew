  ...
  return (
    <div className='bg-white'>
      ...
      <div className='text-black lg:px-16 px-4 leading-9 lg:leading-10 pt-24 lg:pt-16'>
        ...
        <p className='text-lg font-bold'>Feel happy to select self drive cars from Kukatpally</p>
        ...
        <p className='text-lg font-bold'>Say yes to self drive cars rental, Hyderabad</p>
        ...
        <p>When you hear of Hyderabad you quickly think of the world famous Biryani with its aromatic spices or the famed pearls that the city is known for. However, in between and above much more remains to be explored, as the city is a haven for sensory delights.</p>
        ...
        <p className='text-lg font-bold'>Kukatpally self drive cars Long Drive Cars</p>
        ...
        <p className='text-lg font-bold'>For hiring self drive cars near Kukatpally, read on…</p>
        ...
        <p className='text-lg font-bold'>Self drive car rental in Kukatpally doesn't get better than this</p>
        ...
        <p className='text-lg font-bold'>Good news for 'car rental for self driven' in Kukatpally</p>
        ...
        <p>Firstly, you need to possess a valid driver’s license, either Indian or international.</p>
        <p>Secondly, you must be an adult, in simple words over 21 years of age.</p>
        <p>Nextly, when you go to collect the vehicle, you are required to pay a damage deposit in advance.</p>
        ...
        <p>There are many benefits of self driving a rental car on your visit to Hyderabad, India:</p>
        <p>1: No waiting for driving to your destination</p>
        ...
        <p>2: Convenience of navigation system</p>
        ...
        <p className='text-lg font-bold'>4: Go where bus or cab cannot take you</p>
        ...
        <p className='text-lg font-bold'>5: Enjoy rural India as you like</p>
