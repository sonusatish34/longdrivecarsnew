  ...
  return (
    <div className='bg-white'>
      ...
      <div className='text-black lg:px-16 px-4 leading-9 lg:leading-10 pt-32 lg:pt-16'>
        ...
        <p className='text-lg font-bold py-2 lg:py-4'></p>
        ...
        <p className='text-lg font-bold py-2 lg:py-4'>4: Go where bus or cab cannot take you</p>
        ...
        <p className='text-lg font-bold py-2 lg:py-4'>5: Enjoy rural India as you like</p>
