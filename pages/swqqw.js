      ...
      <BlogLayout>
        <section className="section">
          ...
          <div className='flex flex-col lg:px-0 py-2 lg:py-2'>
            <div className='xl:mx-96 lg:mx-56 mx-10'>
            ...
            <div className='flex lg:gap-6 gap-4 py-3 text-sm lg:text-lg xl:mx-96 lg:mx-56 mx-10'>
            ...
            <ul className="py-2 flex  items-center justify-start gap-x-8 text-xs lg:text-base xl:mx-96 lg:mx-56 mx-10">
            ...
            <div className='flex gap-8 py-4 border-t-2 border-b-2 xl:mx-96 lg:mx-56 px-10' >
            ...
            <div className="pt-4 xl:mx-96 lg:mx-56 mx-10">
              <p className="text-xl font-semibold">Related Posts</p>
              <div className=" lg:grid-cols-2 grid grid-cols-2 lg:gap-x-8 lg:gap-y-20 xl:gap-y-10   gap-7 pt-6  lg:pt-6">
                {/* {data.length > 0 ? data.map((post, i) => ( */}
                {postlist?.length > 0 ? postlist.slice(0, 4).map((post, i) => (
                  <div key={`key-${i}`} className={"xl:w-[315 px] xl:h-[450px] lg:h-[350px] w-full h-30  "}>
                    <Link href={`/blog/posts/${post.slug.toLowerCase().replace(/ /g, "-")}`} className="block hover:text-orange-500 font-extrabold text-lg xl:text-2xl text-left tracking-tight">
                      {post?.coverimages && (
                        <Image
                          className="rounded-md xl:w-[400px] xl:h-[200px] lg:w-[300px] lg:h-[150px] w-32 h-20 "
                    ...
                    <p className="mb-2 hover:text-orange-400 font-bold lg:text-lg text-xs text-left pt-4 h-16 lg:h-24">
                      <Link href={`/blog/posts/${post.slug.toLowerCase().replace(/ /g, "-")}`} className="block hover:text-primary">
                        {post?.title && post?.title.slice(0, 50)}
                      </Link>
                    </p>

                    <p className="text-left text-xs lg:text:lg h-24 lg:block hidden pt-2">
            ...
            <div className=" py-6 lg:mt-12 flex flex-row xl:mx-96 lg:mx-56 mx-10">
