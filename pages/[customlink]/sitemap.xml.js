...
//     <sitemapindex xmlns="http://www.sitemaps.org/schemas/sitemap/0.9">
//         <sitemap>
//             <loc>${`https://${domain}/hyderabad/k.xml`}</loc>
//         </sitemap>
...
//     const isComDomain = req.headers.host.includes('l');
...
//     // Generate the XML sitemap
//     const sitemap = generateSiteMap(cars, 'https://www.longdrivecars.com');  // Replace 'yourdomain.com' with the actual domain
