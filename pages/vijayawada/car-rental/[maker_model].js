  ...
  return (
    <div>
      <Head>
        ...
        <meta name="description" content="Explore with Self-drive cars starting at ₹1776/day. With low prices, Book Dzire ₹1680/day,Ertiga ₹2496/day or Install Long Drive Cars app for more options." />
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <meta property="og:title" content="  Unlimited km - Travel with low-cost Self drive car rentals services" />
        <meta property="og:description" content="Explore with Self-drive cars starting at ₹1776/day. With low prices, Book Dzire ₹1680/day,Ertiga ₹2496/day or Install Long Drive Cars app for more options." />
...
export async function getServerSideProps(context) {
  ...
  const canonicalUrl = host.includes('.in')
    ...
    : `https://www.longdrivecars.com/vijayawada/car-rental/${maker_model}`;
  return {
    props: {
      canonicalUrl,
    },
