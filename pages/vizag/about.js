...
function about({ canonicalUrl }) {
    return (
        <Layout locname={'vizag'} phoneno={"9000-478-478"}>
            <Head>
                <title>Learn About Our Self Drive Car Rental Services in Vizag</title>
                <meta property="og:title" content="Learn About Our Self Drive Car Rental Services in Vizag" />
